...
public class SpuDTO extends BaseDTO {
    ...
    @ApiModelProperty(value = "1级分类id", example = "1")
    @NotNull(message = "1级分类id不能为空",groups = {MingruiOperation.Add.class})
    private Integer cid1;

    @ApiModelProperty(value = "2级分类id", example = "1")
    @NotNull(message = "2级分类id不能为空",groups = {MingruiOperation.Add.class})
    private Integer cid2;

    @ApiModelProperty(value = "3级分类id", example = "1")
    @NotNull(message = "3级分类id不能为空",groups = {MingruiOperation.Add.class})
